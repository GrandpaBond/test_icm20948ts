...
// ...followed by XOUT_L, YOUT_H, YOUT_L, ZOUT_H, ZOUT_L in 0x2E..0x32
const ICM20948_GRYO_XOUT_H = 0x33
// ...followed by XOUT_L, YOUT_H, YOUT_L, ZOUT_H, ZOUT_L in 0x34..0x38
...
const ICM20948_FIFO_MODE = 0x69
const ICM20948_FIFO_COUNTH = 0x70
const ICM20948_FIFO_COUNTL = 0x71
const ICM20948_FIFO_R_W = 0x72
    ...
    */
    ...
    dumpRegisters(bank: number) {
        switch (bank) {
            case 0:
                ...
                this.useBank(0)
                pause(100)
                serial.writeLine("WHO_AM_I = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_WHO_AM_I)))
                pause(100)
                serial.writeLine("USER_CTRL = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_USER_CTRL)))
                pause(100)
                serial.writeLine("PWR_MGMT_1 = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_PWR_MGMT_1)))
                pause(100)
                serial.writeLine("PWR_MGMT_2 = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_PWR_MGMT_2)))
                pause(100)
                serial.writeLine("INT_PIN_CFG = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_INT_PIN_CFG)))
                pause(100)
                serial.writeLine("ACCEL_SMPLRT_DIV_1 = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_ACCEL_SMPLRT_DIV_1)))
                pause(100)
                serial.writeLine("ACCEL_SMPLRT_DIV_2 = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_ACCEL_SMPLRT_DIV_2)))
                pause(100)
                serial.writeLine("ACCEL_INTEL_CTRL = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_ACCEL_INTEL_CTRL)))
                pause(100)
                serial.writeLine("ACCEL_WOM_THR = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_ACCEL_WOM_THR)))
                pause(100)
                serial.writeLine("ACCEL_CONFIG = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_ACCEL_CONFIG)))
                // serial.writeLine("ACCEL_XOUT_H = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_ACCEL_XOUT_H)))
                this.dumpIcmWordsBE("ACCEL_XYZ", ICM20948_ACCEL_XOUT_H, 6)
                pause(100)
                // serial.writeLine("GRYO_XOUT_H = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_GRYO_XOUT_H)))
                this.dumpIcmWordsBE("GYRO_XYZ", ICM20948_GRYO_XOUT_H, 6)
                pause(100)
                serial.writeLine("TEMP_OUT_H = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_TEMP_OUT_H)))
                pause(100)
                serial.writeLine("TEMP_OUT_L = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_TEMP_OUT_L)))
                // serial.writeLine("EXT_SLV_SENS_DATA_XYZ " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_EXT_SLV_SENS_DATA_00)))
                this.dumpIcmWordsLE("SLAVE_MAG_XYZ", ICM20948_EXT_SLV_SENS_DATA_00, 6)
                pause(100)
            ...
            case 2:
                ...
                this.useBank(2)
                pause(100)
                serial.writeLine("GYRO_SMPLRT_DIV = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_GYRO_SMPLRT_DIV)))
                pause(100)
                serial.writeLine("GYRO_CONFIG_1 = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_GYRO_CONFIG_1)))
                pause(100)
                serial.writeLine("GYRO_CONFIG_1_GYRO_FS_SEL_MASK = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_GYRO_CONFIG_1_GYRO_FS_SEL_MASK)))
                pause(100)
                serial.writeLine("GYRO_CONFIG_1_GYRO_DLPCFCFG_MASK = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_GYRO_CONFIG_1_GYRO_DLPCFCFG_MASK)))
                pause(100)
                serial.writeLine("GYRO_CONFIG_2 = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_GYRO_CONFIG_2)))
                pause(100)
                serial.writeLine("ODR_ALIGN_EN = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_ODR_ALIGN_EN)))
                pause(100)
                serial.writeLine("ACCEL_SMPLRT_DIV_1 = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_ACCEL_SMPLRT_DIV_1)))
                pause(100)
                serial.writeLine("ACCEL_SMPLRT_DIV_2 = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_ACCEL_SMPLRT_DIV_2)))
                ...
                serial.writeLine("ACCEL_WOM_THR = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_ACCEL_WOM_THR)))
                pause(100)
                serial.writeLine("ACCEL_CONFIG_1 = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_ACCEL_CONFIG_1)))
                pause(100)
                serial.writeLine("ACCEL_CONFIG_1_ACCEL_FS_SEL_MASK = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_ACCEL_CONFIG_1_ACCEL_FS_SEL_MASK)))
                pause(100)
                serial.writeLine("ACCEL_CONFIG_1_ACCEL_DLPFCFG_MASK = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_ACCEL_CONFIG_1_ACCEL_DLPFCFG_MASK)))
                pause(100)
                serial.writeLine("ACCEL_CONFIG_2 = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_ACCEL_CONFIG_2)))
                pause(100)
                serial.writeLine("PRS_ODR_CONFIG = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_PRS_ODR_CONFIG)))
                pause(100)
                serial.writeLine("PRGM_START_ADDRH = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_PRGM_START_ADDRH)))
                pause(100)
                serial.writeLine("PRGM_START_ADDRL = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_PRGM_START_ADDRL)))
                pause(100)
                serial.writeLine("FSYNC_CONFIG = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_FSYNC_CONFIG)))
                pause(100)
                serial.writeLine("TEMP_CONFIG = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_TEMP_CONFIG)))
                pause(100)
                serial.writeLine("MOD_CTRL_USR = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_MOD_CTRL_USR)))
                pause(100)
                serial.writeLine("MOD_CTRL_USR_REG_LP_DMP_EN = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_MOD_CTRL_USR_REG_LP_DMP_EN)))
                pause(100)
                break
            ...
            case 3:
                ...
                this.useBank(3)
                pause(100)
                serial.writeLine("I2C_MST_ODR_CONFIG = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_MST_ODR_CONFIG)))
                pause(100)
                serial.writeLine("I2C_MST_CTRL = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_MST_CTRL)))
                pause(100)
                serial.writeLine("I2C_MST_DELAY_CTRL = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_MST_DELAY_CTRL)))
                pause(100)
                serial.writeLine("I2C_SLV0_ADDR = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_SLV0_ADDR)))
                pause(100)
                serial.writeLine("I2C_SLV0_REG = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_SLV0_REG)))
                pause(100)
                serial.writeLine("I2C_SLV0_CTRL = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_SLV0_CTRL)))
                pause(100)
                serial.writeLine("I2C_SLV0_DO = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_SLV0_DO)))
                pause(100)
                serial.writeLine("I2C_SLV1_ADDR = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_SLV1_ADDR)))
                pause(100)
                serial.writeLine("I2C_SLV1_REG = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_SLV1_REG)))
                pause(100)
                serial.writeLine("I2C_SLV1_CTRL = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_SLV1_CTRL)))
                pause(100)
                serial.writeLine("I2C_SLV1_DO = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_SLV1_DO)))
                pause(100)
                pause(100)
                serial.writeLine("I2C_SLV2_ADDR = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_SLV2_ADDR)))
                pause(100)
                serial.writeLine("I2C_SLV2_REG = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_SLV2_REG)))
                pause(100)
                serial.writeLine("I2C_SLV2_CTRL = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_SLV2_CTRL)))
                pause(100)
                serial.writeLine("I2C_SLV2_DO = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_SLV2_DO)))
                pause(100)
                serial.writeLine("I2C_SLV3_ADDR = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_SLV3_ADDR)))
                pause(100)
                serial.writeLine("I2C_SLV3_REG = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_SLV3_REG)))
                pause(100)
                serial.writeLine("I2C_SLV3_CTRL = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_SLV3_CTRL)))
                pause(100)
                serial.writeLine("I2C_SLV3_DO = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_SLV3_DO)))
                pause(100)
                serial.writeLine("I2C_SLV4_ADDR = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_SLV4_ADDR)))
                pause(100)
                serial.writeLine("I2C_SLV4_REG = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_SLV4_REG)))
                pause(100)
                serial.writeLine("I2C_SLV4_CTRL = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_SLV4_CTRL)))
                pause(100)
                serial.writeLine("I2C_SLV4_DO = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_SLV4_DO)))
                pause(100)
                serial.writeLine("I2C_SLV4_DI = " + hexByte(i2cReadByte(ICM20948_I2C_ADDR, ICM20948_I2C_SLV4_DI)))
                pause(100)
                break
            ...
            case 4:
                ...
                pause(100)
                serial.writeLine("AK09916_WIA2 = " + hexByte(this.readMagByte(AK09916_WIA2)))
                pause(100)
                serial.writeLine("AK09916_ST1 = " + hexByte(this.readMagByte(AK09916_ST1)))
                pause(100)
                for (let i = 0; i < 6; i++) {
                    serial.writeLine("AK09916_DATA = " + hexByte(this.readMagByte(AK09916_HXL + i)))
                    pause(100)
                }
                this.dumpMagWordsLE("AK09916_VALS", AK09916_HXL, 6) // sensor data
                pause(100)
                serial.writeLine("AK09916_ST2 = " + hexByte(this.readMagByte(AK09916_ST2)))
                pause(100)
                serial.writeLine("AK09916_CNTL2 = " + hexByte(this.readMagByte(AK09916_CNTL2)))
                pause(100)
                serial.writeLine("AK09916_CNTL3 = " + hexByte(this.readMagByte(AK09916_CNTL3)))
                pause(100)
                break
        }
    }
    ...
    dumpIcmWordsBE(fromName: string, fromReg: number, length: number) {
        for (let i = 0; i < length; i += 2) {
            let hi = hexByte(i2cReadByte(ICM20948_I2C_ADDR, fromReg + i))
            let lo = hexByte(i2cReadByte(ICM20948_I2C_ADDR, fromReg + i + 1))
    ...
    dumpIcmWordsLE(fromName: string, fromReg: number, length: number) {
        for (let i = 0; i < length; i += 2) {
            let lo = hexByte(i2cReadByte(ICM20948_I2C_ADDR, fromReg + i))
            let hi = hexByte(i2cReadByte(ICM20948_I2C_ADDR, fromReg + i + 1))
            serial.writeLine(fromName + "[" + i + "] = " + hi + lo.substr(2))
        }
    }
    ...
    dumpMagWordsLE(fromName: string, fromReg: number, length: number) {
        for (let i = 0; i < length; i += 2) {
            let lo = hexByte(this.readMagByte(fromReg + i))
            let hi = hexByte(this.readMagByte(fromReg + i + 1))
            serial.writeLine(fromName + "[" + i + "] = " + hi + lo.substr(2))
        }
    }
}
